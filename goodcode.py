...
class SpellerGridApp:
    ...
    def __init__(self, root):
        ...
        self.buttons = [[tk.Button(self.grid_frame, text='', width=4, height=1, font=('Helvetica', 200),command=lambda i=i, j=j: self.cell_clicked(i, j))
    ...
    def phase0(self):
        self.buttons[0][0].configure(text="Here is your card",bg="white", fg="black", width=29, height=10, font=('Helvetica', 75))
    ...
    def phase1(self):
        ...
        if (value == 1):
            self.buttons[0][0].configure(text="♠", bg="white", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][0].configure(text="♥", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[0][1].configure(text="♦", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][1].configure(text="♣", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)

        elif(value == 2):
            self.buttons[0][0].configure(text="♠", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][0].configure(text="♥", bg="white", fg="red", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[0][1].configure(text="♦", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][1].configure(text="♣", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            ...
            self.buttons[0][0].configure(text="♠", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][0].configure(text="♥", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[0][1].configure(text="♦", bg="white", fg="red", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][1].configure(text="♣", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            ...
            self.buttons[1][0].configure(text="♥", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[0][1].configure(text="♦", bg="black", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
            self.buttons[1][1].configure(text="♣", bg="white", fg="black", width=4, height=1, font=('Helvetica',200), bd=0)
    ...
    def phasePost1(self):
        ...
        self.buttons[0][0].configure(text="Now Find Your Card...",bg="white", fg="black", width=29, height=10, font=('Helvetica', 75))
    ...
    def startThreadOne(self):
        ...
        #insert_button = tk.Button(self.grid_frame, text='', width=4, height=1, font=('Helvetica', 200))
    ...
    def circleThroughOptions(self):
        ...
        if(self.buttons[0][0].cget('bg') == "white"):
            self.buttons[0][0].configure(text="♥", bg="black", fg="black", width=4, height=1, font=('Helvetica',200))
            self.buttons[0][1].configure(text="♦", bg="white", fg="red", width=4, height=1, font=('Helvetica',200))
            self.root.after(1500, self.circleThroughOptions)
        
        elif(self.buttons[0][1].cget('bg') == "white"):
            self.buttons[0][1].configure(text="♠", bg="black", fg="black", width=4, height=1, font=('Helvetica',200))
            self.buttons[1][0].configure(text="♥", bg="white", fg="red", width=4, height=1, font=('Helvetica',200))
            self.root.after(1500, self.circleThroughOptions)

        elif(self.buttons[1][0].cget('bg') == "white"):
            self.buttons[1][0].configure(text="♦", bg="black", fg="black", width=4, height=1, font=('Helvetica',200))
            self.buttons[1][1].configure(text="♣", bg="white", fg="black", width=4, height=1, font=('Helvetica',200))
            self.root.after(1500, self.circleThroughOptions)

        elif (self.buttons[1][1].cget('bg') == "white"):
            self.buttons[1][1].configure(text="♣", bg="black", fg="black", width=4, height=1, font=('Helvetica',200))
            self.buttons[0][0].configure(text="♠", bg="white", fg="black", width=4, height=1, font=('Helvetica',200))
            self.root.after(1500, self.circleThroughOptions)
