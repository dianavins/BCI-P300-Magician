...
class SpellerGridApp:
    ...
    def phase0(self):
        self.buttons[0][0].configure(text="Here is your card",bg="white", fg="black", width=28, height=10, font=('Helvetica', 75))
    ...
    def phase1(self):
        ...
        if (value == 1):
            self.buttons[0][0].configure(text="♠", bg="white",fg="black",width=11, height=3, font=('Helvetica', 200))
        elif(value == 2):
            self.buttons[0][0].configure(text="♥", bg="white",fg="red",width=11, height=3, font=('Helvetica', 200))
        elif(value == 3):
            self.buttons[0][0].configure(text="♣", bg="white",fg="black",width=11, height=3, font=('Helvetica', 200))
        elif(value == 4):
            self.buttons[0][0].configure(text="♦", bg="white",fg="red",width=11, height=3, font=('Helvetica', 200))
    ...
    def phasePost1(self):
        ...
        self.buttons[0][0].configure(text="Now Find Your Card...",bg="white", fg="black", width=28, height=10, font=('Helvetica', 75))
