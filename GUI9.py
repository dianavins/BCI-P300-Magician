...
class SpellerGridApp:
    ...
    def checkForInput(self):
        ...
        #*The 5 seen below can be changed and the number that is put in is how many cards show before stopping
        #print(self.count)
        if (self.count == len(self.labelList)*30):
